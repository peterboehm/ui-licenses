...
class Routing extends Component {
  ...
  render() {
    ...
    // see get modules() in ui-licenses/ui/src/lib/folio-stripes/app.js for details
    ...
    let mods = this.app.modules.values().map((entry, index) => {
      ...
      return (<ModRoutes key={`ui-licenses-lazy-routes-${index}`} {...this.props} app={this.app} />)
    })

    return (
      <div className="ui-licenses" >
